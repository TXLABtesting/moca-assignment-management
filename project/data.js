...
// All UAE federal entities. All values consistent with the policy rules in the brief.
...
window.GRADE_INDEX = id => window.GRADES.findIndex(g => g.id === id);
window.GET_GRADE = id => window.GRADES.find(g => g.id === id);
// Grade 5 and above (incl. HE special): only secondment is permitted — no acting, loan or borrowing.
window.IS_SENIOR_GRADE = id => id === '5' || id === 'HE special';
...
window.GET_ENTITY = id => window.ENTITIES.find(e => e.id === id);
...
window.ENTITY_LABEL = (idOrName, lang) => {
  const e = window.GET_ENTITY(idOrName);
  if (e) return lang === 'ar' ? e.ar : e.en;
  return idOrName || '—';
};

window.EMPLOYEES = [
  { id: 'E-204815', en: 'Ahmed Al Mansoori',    ar: 'أحمد المنصوري',    eid: '784-1988-1234567-3', entity: 'moca',  position_en: 'Senior Cultural Programmes Specialist', position_ar: 'أخصائي أول برامج ثقافية', grade: '3.2', joined: '2016-09-12' },
  { id: 'E-198432', en: 'Fatima Al Zaabi',      ar: 'فاطمة الزعابي',     eid: '784-1985-9876543-1', entity: 'mof',   position_en: 'Financial Analyst', position_ar: 'محلل مالي', grade: '3.1', joined: '2018-02-04' },
  { id: 'E-221056', en: 'Mohammed Al Hashimi',  ar: 'محمد الهاشمي',     eid: '784-1990-2345678-9', entity: 'moei',  position_en: 'Infrastructure Project Manager', position_ar: 'مدير مشاريع البنية التحتية', grade: '4.1', joined: '2014-05-21' },
  { id: 'E-187234', en: 'Mariam Al Suwaidi',    ar: 'مريم السويدي',      eid: '784-1991-3456789-2', entity: 'mohre', position_en: 'HR Policy Advisor', position_ar: 'مستشار سياسات الموارد البشرية', grade: '3.3', joined: '2017-11-08' },
  { id: 'E-249871', en: 'Khalid Al Marri',      ar: 'خالد المري',        eid: '784-1989-4567890-5', entity: 'moe',   position_en: 'Education Policy Officer', position_ar: 'مسؤول سياسات تعليمية', grade: '2.3', joined: '2019-08-15' },
  { id: 'E-210645', en: 'Noura Al Kaabi',       ar: 'نورا الكعبي',       eid: '784-1986-5678901-7', entity: 'mocd',  position_en: 'Community Programmes Lead', position_ar: 'قائد برامج مجتمعية', grade: '4.2', joined: '2013-03-30' },
  { id: 'E-235712', en: 'Saif Al Falasi',       ar: 'سيف الفلاسي',       eid: '784-1992-6789012-3', entity: 'mohap', position_en: 'Public Health Specialist', position_ar: 'أخصائي صحة عامة', grade: '3.1', joined: '2018-10-22' },
  { id: 'E-194523', en: 'Hessa Al Nuaimi',      ar: 'حصة النعيمي',       eid: '784-1987-7890123-4', entity: 'moj',   position_en: 'Legal Counsel', position_ar: 'مستشار قانوني', grade: '4.3', joined: '2012-06-19' },
  { id: 'E-218396', en: 'Abdullah Al Shamsi',   ar: 'عبدالله الشامسي',   eid: '784-1990-8901234-8', entity: 'tdra',  position_en: 'Digital Transformation Lead', position_ar: 'قائد التحول الرقمي', grade: '4.1', joined: '2015-12-01' },
  { id: 'E-260128', en: 'Reem Al Mazrouei',     ar: 'ريم المزروعي',      eid: '784-1993-9012345-6', entity: 'mofa',  position_en: 'Diplomatic Affairs Officer', position_ar: 'مسؤول شؤون دبلوماسية', grade: '2.2', joined: '2020-04-17' },
];

window.GET_EMPLOYEE = id => window.EMPLOYEES.find(e => e.id === id);
...
window.ASSIGNMENTS = [
  ...
  },
  {
    ...
    awaitingApprover: 'entity_head', updatedAt: '2026-05-19T09:42:00',
  },
  {
  ...
  },
  {
    ...
    employeeId: 'E-187234', fromEntity: 'mohre', toEntity: 'fahr',
  ...
  },
  {
    ...
    awaitingApprover: 'hr', updatedAt: '2026-05-20T16:21:00',
  },
  {
  ...
  },
  {
    ...
    employeeId: 'E-218396', fromEntity: 'tdra', toEntity: 'moca',
...
// Approval timeline data for the detail screen — for ASG-2025-00211 (pending)
window.SAMPLE_TIMELINE = [
  {
    role: 'submitter', name_en: 'Mariam Al Mansoori', name_ar: 'مريم المنصوري',
    role_en: 'HR Officer — Submitted', role_ar: 'موظف موارد بشرية — قدّم الطلب',
    status: 'done', timestamp: '2026-05-18T09:14:00',
    comment_en: 'Submitted following coordination with both entities. Employee consent attached.',
    comment_ar: 'قُدّم بعد التنسيق مع الجهتين. مرفق خطاب موافقة الموظف.',
  },
  {
    role: 'lm', name_en: 'Dr. Saeed Al Tayer', name_ar: 'د. سعيد الطاير',
    role_en: 'Line Manager — Ministry of Education', role_ar: 'المدير المباشر — وزارة التربية والتعليم',
    status: 'done', timestamp: '2026-05-19T08:42:00',
    comment_en: 'Approved. Khalid is the right fit for this initiative and his current workload allows the transition.',
    comment_ar: 'معتمد. خالد هو المرشح المناسب لهذه المبادرة وعبء العمل الحالي يسمح بالانتقال.',
  },
  {
    role: 'hr', name_en: 'Aisha Al Hosani', name_ar: 'عائشة الحوسني',
    role_en: 'HR Department — MoE', role_ar: 'إدارة الموارد البشرية — وزارة التربية والتعليم',
    status: 'active', timestamp: null,
    comment_en: null, comment_ar: null,
  },
  {
    role: 'entity_head', name_en: '—', name_ar: '—',
    role_en: 'Entity Head — Ministry of Community Development', role_ar: 'رئيس الجهة — وزارة تنمية المجتمع',
    status: 'pending', timestamp: null,
  },
];

window.formatDate = (iso, lang) => {
  if (!iso) return '—';
...
window.GET_ENTITLEMENTS = (emp, durationDays, lang) => {
  if (!emp) return [];
  const g = window.GET_GRADE(emp.grade);
  const basic = g ? g.basic : 0;
  const fmt = n => window.formatAED(n, lang);
  const yearsServed = Math.max(0, Math.floor((Date.now() - new Date(emp.joined).getTime()) / (365.25 * 86400000)));
  const senior = window.GRADE_INDEX(emp.grade) >= window.GRADE_INDEX('4.1');
